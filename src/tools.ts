...
export const toolHandlers = {
  async getAliasInfo(client: TerminalDocsClient, args: any) {
  ...
  async getCommandsByCategory(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
  ...
  async getCommandsByType(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
  ...
  async getDatabaseStats(client: TerminalDocsClient, args: any) {
    try {
  ...
  async getCommandInfo(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
    ...
    try {
      const result = await client.getCommandInfo(
        args.command,
  ...
  async enhancePrompt(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
    ...
    try {
      const result = await client.enhancePrompt(
        ...
        args.enhancement_level || 'core',
        args.context || '',
        args.target_audience || 'intermediate'
      );
  ...
  async searchCommands(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
  ...
  async explainOutput(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
    ...
    try {
      const result = await client.explainOutput(
        args.command,
        args.output,
        args.context || ''
      );
  ...
  async validateCommand(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
    ...
    try {
      const result = await client.validateCommand(
        args.command,
        args.safety_level || 'moderate'
      );
  ...
  async createWorkflow(client: TerminalDocsClient, args: any) {
    let errors: ValidationError[] = [];
    ...
    try {
      const result = await client.createWorkflow(
        ...
        args.include_error_handling ?? true,
        args.output_format || 'script'
      );
